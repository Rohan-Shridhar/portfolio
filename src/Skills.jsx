...
const sql = "images/DBs/mysql.png"
    ...
    return (
        <div className="skills-cont" id="skills">
            ...
            <div className="skill-row-1">
                <div className="skill-js" id="skill"><img src={js} alt="js" /><br /><hr />Intermediate</div>
                <div className="skill-java" id="skill"><img src={java} alt="java" /><br /><hr />Intermediate</div>
                <div className="skill-py" id="skill"><img src={python} alt="python" /><br /><hr />Beginner</div>
                <div className="skill-cpp" id="skill"><img src={cpp} alt="cpp" /><br /><hr />Intermediate</div>
                <div></div>
                <p className="lang">Languages</p>
            </div>
            <div className="skill-row-2">
                <div className="skill-html" id="skill"><img src={html} alt="html" /><br /><hr />Intermediate</div>
                <div className="skill-css" id="skill"><img src={css} alt="css" /><br /><hr />Intermediate</div>
                <div className="skill-react" id="skill"><img src={react} alt="react" /><br /><hr />Intermediate</div>
                <div></div>
                <p className="lang">Web Dev</p>
            </div>
            <div className="skill-row-3">
                <div className="skill-sql" id="skill"><img src={sql} alt="PostgresSql" /><br /><hr />Intermediate</div>
                <div className="skill-mongodb" id="skill"><img src={mongodb} alt="mongodb" /><br /><hr />Beginner</div>
                <div></div>
                <p className="lang">Databases</p>
            </div>
            <div className="skill-row-4">
                <div className="skill-git" id="skill"><img src={git} alt="Git version control" /><br /><hr />Version Control</div>
